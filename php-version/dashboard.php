...
<head>
    ...
    <title>Admin Dashboard - Doğru Hoca</title>
        ...
        <main class="main-content">
            ...
            <section id="overview-section" class="content-section active">
                <div class="section-header">
                    ...
                    <p class="section-description">Dashboard'a hoş geldiniz! Buradan tüm site içeriğini yönetebilirsiniz.</p>
                </div>
                ...
                <div class="welcome-card">
                    ...
                    <div>
                        ...
                        <p>Sol menüden yönetmek istediğiniz bölümü seçin. Her bölümde içerik ekleyebilir, düzenleyebilir veya silebilirsiniz.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="site-info-section" class="content-section">
                <div class="section-header">
                    <div>
                        ...
                        <p class="section-description">Ana sayfadaki "Hakkımda" ve "İletişim" bölümlerini buradan düzenleyin</p>
                    </div>
                </div>
                ...
                <form id="site-info-form" class="info-form">
                    <div class="form-card">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="about_text" name="about_text" rows="6" class="form-control" placeholder="Kendiniz hakkında bilgi yazın..."></textarea>
        ...
        <div class="modal-content">
            ...
            <form id="video-form">
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="video-url" class="form-control" placeholder="https://www.youtube.com/embed/..." required>
