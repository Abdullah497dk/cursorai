                ...
                const html = questions.map(q => {
                    ...
                    return `
                        <div class="video-card" style="margin-bottom: 2rem;">
                            ...
                            ${q.image_path ? `<img src="static/${escapeHtml(q.image_path)}" alt="Soru görseli" class="question-image" style="max-width: 100%; height: 500px; border-radius: 8px; margin: 1rem 0;">` : ''}
                            ...
                            <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid #ecf0f1;">
                                ...
                                ${(q.answers || []).map(a => `
                                    <div style="background: #f8f9fa; padding: 1rem; border-radius: 8px; margin-bottom: 0.75rem;">
                                        ...
                                        ${a.image_path ? `<img src="static/${escapeHtml(a.image_path)}" alt="Cevap görseli" class="answer-image" style="max-width: 100%; height: 500px; border-radius: 8px; margin: 0.5rem 0;">` : ''}
                                        <p style="font-size: 0.85rem; color: #7f8c8d;">
